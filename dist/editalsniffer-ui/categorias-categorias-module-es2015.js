...
let CategoriaCadastroComponent = class CategoriaCadastroComponent {
    constructor(categoriaService, messageService, errorHandler, route, router, title) {
...
CategoriaCadastroComponent.ctorParameters = () => [
...
let CategoriasPesquisaComponent = class CategoriasPesquisaComponent {
    constructor(categoriaService, errorHandler, confirmation, messageService, title) {
        this.categoriaService = categoriaService;
        this.errorHandler = errorHandler;
...
CategoriasPesquisaComponent.ctorParameters = () => [
