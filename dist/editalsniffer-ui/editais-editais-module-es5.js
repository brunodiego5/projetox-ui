...
var ConcorrenteService = /** @class */ (function () {
    function ConcorrenteService(http) {
        this.http = http;
        this.concorrentesUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/concorrentes";
    }
    ConcorrenteService.prototype.listarTodos = function () {
        return this.http.get(this.concorrentesUrl);
    };
    ConcorrenteService.ctorParameters = function () { return [
...
var Contato = /** @class */ (function () {
    function Contato(codigo, nome, email, telefone) {
        this.codigo = codigo;
        this.nome = nome;
        this.email = email;
        this.telefone = telefone;
    }
    Contato.ctorParameters = function () { return [
        { type: Number },
        { type: String },
        { type: String },
        { type: String }
...
var Concorrente = /** @class */ (function () {
...
var EditaisPesquisaComponent = /** @class */ (function () {
    function EditaisPesquisaComponent(editalService, errorHandler, confirmation, messageService, title) {
    ...
    EditaisPesquisaComponent.prototype.ngOnInit = function () {
        this.title.setTitle('Pesquisa de editais');
    };
    EditaisPesquisaComponent.prototype.pesquisar = function (pagina) {
        var _this = this;
        ...
        this.editalService.pesquisar(this.filtro)
            ...
            _this.editais = dados.content;
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    EditaisPesquisaComponent.prototype.aoMudarPagina = function (event) {
        var pagina = event.first / event.rows;
        this.pesquisar(pagina);
    };
    EditaisPesquisaComponent.prototype.confirmarExclusao = function (edital) {
        var _this = this;
        this.confirmation.confirm({
            message: 'Tem certeza que deseja excluir?',
            accept: function () {
                _this.excluir(edital);
            }
        });
    };
    EditaisPesquisaComponent.prototype.excluir = function (item) {
        var _this = this;
        this.editalService.excluir(item.id)
            ...
            _this.messageService.add({ severity: 'success', detail: 'Edital excluído com sucesso!' });
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    EditaisPesquisaComponent.ctorParameters = function () { return [
    ...
    return EditaisPesquisaComponent;
}());
...
var EditaisRoutingModule = /** @class */ (function () {
    function EditaisRoutingModule() {
    }
...
var EditaisModule = /** @class */ (function () {
    function EditaisModule() {
    }
...
var EditalCadastroComponent = /** @class */ (function () {
    function EditalCadastroComponent(editalService, concorrenteService, messageService, errorHandler, route, router, title) {
        this.editalService = editalService;
    ...
    EditalCadastroComponent.prototype.antesUploadAnexo = function (event) {
        event.xhr.setRequestHeader('Authorization', 'Bearer ' + localStorage.getItem('token'));
        this.uploadEmAndamento = true;
    };
    EditalCadastroComponent.prototype.aoTerminarUploadAnexo = function (event) {
        var anexo = JSON.parse(event.xhr.response);
        this.edital.anexo = anexo.nome;
        this.edital.urlAnexo = anexo.url;
        this.uploadEmAndamento = false;
    };
    EditalCadastroComponent.prototype.erroUpload = function (event) {
        this.messageService.add({ severity: 'error', detail: 'Erro ao tentar enviar anexo!' });
        this.uploadEmAndamento = false;
    };
    EditalCadastroComponent.prototype.removerAnexo = function () {
        this.edital.anexo = null;
        this.edital.urlAnexo = null;
    };
    Object.defineProperty(EditalCadastroComponent.prototype, "nomeAnexo", {
        get: function () {
            var nome = this.edital.anexo;
            if (nome) {
    ...
    Object.defineProperty(EditalCadastroComponent.prototype, "urlUploadAnexo", {
        get: function () {
    ...
    EditalCadastroComponent.prototype.ngOnInit = function () {
        var idEdital = this.route.snapshot.params['id'];
    ...
    EditalCadastroComponent.prototype.carregarEstados = function () {
        var _this = this;
        this.editalService.listarEstados().subscribe(function (lista) {
            _this.estados = lista.map(function (uf) { return ({ label: uf.nome, value: uf.codigo }); });
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    EditalCadastroComponent.prototype.carregarCidades = function () {
        var _this = this;
        this.editalService.pesquisarCidades(this.estadoSelecionado).subscribe(function (lista) {
            _this.cidades = lista.map(function (c) { return ({ label: c.nome, value: c.codigo }); });
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    EditalCadastroComponent.prototype.carregarConcorrentes = function () {
        var _this = this;
        return this.concorrenteService.listarTodos()
            .subscribe(function (concorrentes) {
            _this.concorrentes = concorrentes
                .map(function (c) { return ({ label: c.nome, value: c.id }); });
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    Object.defineProperty(EditalCadastroComponent.prototype, "editando", {
        get: function () {
    ...
    EditalCadastroComponent.prototype.carregarEdital = function (id) {
        var _this = this;
        this.editalService.buscarPorId(id)
            .subscribe(function (edital) {
            ...
            _this.edital = edital;
            _this.editalService.converterStringsParaDatas([_this.edital]);
            _this.estadoSelecionado = (_this.edital.cidade) ?
                _this.edital.cidade.estado.codigo : null;
            if (_this.estadoSelecionado) {
                _this.carregarCidades();
            }
            _this.atualizarTituloEdicao();
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    // salvar(form: FormControl) {
    EditalCadastroComponent.prototype.salvar = function (form) {
        if (this.editando) {
    ...
    EditalCadastroComponent.prototype.adicionarEdital = function (form) {
        var _this = this;
        this.editalService.adicionar(this.edital)
            .subscribe(function (editalAdicionado) {
            _this.messageService.add({ severity: 'success', detail: 'Edital adicionado com sucesso!' });
            _this.router.navigate(['/editais', editalAdicionado.id]);
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    EditalCadastroComponent.prototype.atualizarEdital = function (form) {
        var _this = this;
        this.editalService.atualizar(this.edital)
            ...
            _this.edital = edital;
            _this.editalService.converterStringsParaDatas([_this.edital]);
            _this.messageService.add({ severity: 'success', detail: 'Edital alterado com sucesso!' });
            _this.atualizarTituloEdicao();
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    //novo(form: FormControl) {
    EditalCadastroComponent.prototype.novo = function (form) {
        form.reset();
        setTimeout(function () {
            this.edital = new _core_model_Edital__WEBPACK_IMPORTED_MODULE_8__["Edital"]();
        }.bind(this), 1);
    ...
    EditalCadastroComponent.prototype.atualizarTituloEdicao = function () {
        this.title.setTitle("Edi\u00E7\u00E3o de edital: " + this.edital.ano + "/" + this.edital.processo + " - " + this.edital.cidade.nome);
    };
    EditalCadastroComponent.ctorParameters = function () { return [
        { type: _edital_service__WEBPACK_IMPORTED_MODULE_6__["EditalService"] },
    ...
    return EditalCadastroComponent;
}());
...
//# sourceMappingURL=editais-editais-module-es5.js.map