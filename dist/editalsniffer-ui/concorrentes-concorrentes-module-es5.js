...
var ConcorrenteCadastroComponent = /** @class */ (function () {
    function ConcorrenteCadastroComponent(concorrenteService, messageService, errorHandler, route, router, title) {
    ...
    ConcorrenteCadastroComponent.prototype.ngOnInit = function () {
        var idConcorrente = this.route.snapshot.params['id'];
        this.title.setTitle('Nova concorrente');
        if (idConcorrente) {
            this.carregarConcorrente(idConcorrente);
        }
    };
    Object.defineProperty(ConcorrenteCadastroComponent.prototype, "editando", {
        get: function () {
    ...
    ConcorrenteCadastroComponent.prototype.carregarConcorrente = function (id) {
        var _this = this;
        this.concorrenteService.buscarPorId(id)
            .subscribe(function (concorrente) {
            _this.concorrente = concorrente;
            _this.atualizarTituloEdicao();
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    ConcorrenteCadastroComponent.prototype.salvar = function (form) {
        if (this.editando) {
    ...
    ConcorrenteCadastroComponent.prototype.adicionarConcorrente = function (form) {
        var _this = this;
        this.concorrenteService.adicionar(this.concorrente)
            .subscribe(function (concorrenteAdicionado) {
            _this.messageService.add({ severity: 'success', detail: 'Concorrente adicionado com sucesso!' });
            _this.router.navigate(['/concorrentes', concorrenteAdicionado.id]);
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    ConcorrenteCadastroComponent.prototype.atualizarConcorrente = function (form) {
        var _this = this;
        this.concorrenteService.atualizar(this.concorrente)
            .subscribe(function (concorrente) {
            _this.concorrente = concorrente;
            _this.messageService.add({ severity: 'success', detail: 'Concorrente alterado com sucesso!' });
            _this.atualizarTituloEdicao();
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    ConcorrenteCadastroComponent.prototype.novo = function (form) {
        form.reset();
        setTimeout(function () {
            this.concorrente = new _core_model_Concorrente__WEBPACK_IMPORTED_MODULE_2__["Concorrente"]();
        }.bind(this), 1);
    ...
    ConcorrenteCadastroComponent.prototype.atualizarTituloEdicao = function () {
        this.title.setTitle("Edi\u00E7\u00E3o de concorrente: " + this.concorrente.nome);
    };
    ConcorrenteCadastroComponent.ctorParameters = function () { return [
    ...
    return ConcorrenteCadastroComponent;
}());
...
var ConcorrentesPesquisaComponent = /** @class */ (function () {
    function ConcorrentesPesquisaComponent(concorrenteService, errorHandler, confirmation, messageService, title) {
        this.concorrenteService = concorrenteService;
        this.errorHandler = errorHandler;
    ...
    ConcorrentesPesquisaComponent.prototype.ngOnInit = function () {
        this.title.setTitle('Pesquisa de concorrentes');
    };
    ConcorrentesPesquisaComponent.prototype.pesquisar = function (pagina, setarPrimeiraPagna) {
        var _this = this;
        ...
        this.concorrenteService.pesquisar(this.filtro)
            ...
            _this.concorrentes = dados.content;
            if (setarPrimeiraPagna) {
                _this.grid.first = 0;
            }
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    ConcorrentesPesquisaComponent.prototype.aoMudarPagina = function (event) {
        var pagina = event.first / event.rows;
        this.pesquisar(pagina, false);
    };
    ConcorrentesPesquisaComponent.prototype.confirmarExclusao = function (concorrente) {
        var _this = this;
        this.confirmation.confirm({
            message: 'Tem certeza que deseja excluir?',
            accept: function () {
                _this.excluir(concorrente);
            }
        });
    };
    ConcorrentesPesquisaComponent.prototype.excluir = function (concorrente) {
        var _this = this;
        this.concorrenteService.excluir(concorrente.id)
            ...
            _this.messageService.add({ severity: 'success', detail: 'Concorrente excluído com sucesso!' });
        }, function (erro) { return _this.errorHandler.handle(erro); });
    };
    ConcorrentesPesquisaComponent.ctorParameters = function () { return [
    ...
    return ConcorrentesPesquisaComponent;
}());
...
var ConcorrentesRoutingModule = /** @class */ (function () {
    function ConcorrentesRoutingModule() {
    }
    ...
    return ConcorrentesRoutingModule;
}());
...
var ConcorrentesModule = /** @class */ (function () {
    function ConcorrentesModule() {
    }
